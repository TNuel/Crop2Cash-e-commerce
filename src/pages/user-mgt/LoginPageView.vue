<template>
  <div class="w-screen min-h-screen lg:grid lg:grid-cols-3">
    <div
      class="hidden lg:flex justify-center items-center bg-secondary">
      <div>
        <img src="../../assets/c2c-logo.svg" alt="Crop2Cash Logo" class="">
      </div>
    </div>

    <div class="font-urbanist h-screen px-6 lg:px-0 lg:col-span-2 my-auto flex flex-col justify-center items-center bg-gradient-to-tr from-white via-white to-secondary/5 lg:to-secondary/25">
      <div class="lg:self-center mx-auto w-full lg:max-w-lg">
        <div class="lg:-ml-20">
          <div class=" my-5 lg:my-10">
            <div class="mb-6">
              <h2 class="text-3xl font-semibold mb-3 text-secondary">Welcome Back</h2>
              <p class="font-urbanist text-textPrimary/70 text-sm md:text-base font-medium leading-5 tracking-normal text-left">Enter your Credentials below to get Started </p>
            </div>

            <div v-if="err" class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
              <span v-if="err == 'Request failed with status code 404'" class="block sm:inline">incorrect login
                credentails</span>
            ...
            <form @submit.prevent="handleLogin" class="py-4">
              <div class="relative text-textPrimary">
                <label class="" for="userEmail">Email Address</label>

                <input id="userEmail" type="text" v-model="userEmail" placeholder="Email Address"
              ...
              <div class="relative my-5 text-textPrimary">
                ...
                <span @click="showPassword = !showPassword">
                  <i class="absolute cursor-pointer top-[3rem] right-[1rem] fa" :class="{
              ...
              <div class="my-10">
                <button
                  ...
                  <!-- <span v-else class="font-semibold text-white text-base lg:text-lg">Log In</span> -->
                  <router-link to="/main" class="text-white transition duration-200 ease-in-out">Log In</router-link>
                </button>
              </div>
              ...
              <div class="flex justify-end">
                <p class="text-sm font-semibold text-textPrimary mt-2 pt-1 mb-0">
                  ...
                  <router-link to="/register" class="text-secondary/80 hover:text-secondary hover:border-b-2 hover:border-secondary focus:text-secondary transition duration-200 ease-in-out">Register</router-link>
                  <!-- <a href="#!"
...
// import "vue3-toastify/dist/index.css";
    ...
    const readyToSubmit = computed(() => {
      return (userEmail.value && password.value) ? true : false;
    });
    ...
    //     err.value = "incorrect login credentails";
    //     setTimeout(() => {
    //       err.value = null;
    //     }, 3000);
    //   }
...
<style scoped>
.gradient-color {
  background: linear-gradient(127.55deg,
