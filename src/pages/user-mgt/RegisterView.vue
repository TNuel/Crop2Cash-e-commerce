        ...
        <div class="lg:self-center mx-auto w-full lg:max-w-lg">
          <div class="lg:-ml-20">
            <div class=" my-5 lg:my-10">
              <div class="mb-6">
                <h2 class="text-3xl font-semibold mb-3 text-secondary">You're Welcome</h2>
              ...
              <form @submit.prevent="handleLogin" class="py-4">
                ...
                <div class="hidden justify-between items-center mb-6">
                ...
                <div class="my-10">
                  <button
                    ...
                    <span v-else class="font-semibold text-white text-base lg:text-lg">Sign Up</span>
                  </button>
                </div>
                ...
                <div class="flex justify-end">
                  <p class="text-sm font-semibold text-textPrimary mt-2 pt-1 mb-0">
                    ...
                    <router-link to="/" class="text-secondary/80 hover:text-secondary hover:border-b-2 hover:border-secondary focus:text-secondary transition duration-200 ease-in-out">Log In</router-link>
                    <!-- <a href="#!"
