  ...
  <nav class="bg-white w-screen border-gray-200 dark:bg-textPrimary/20">
    ...
    >
      <div>
        ...
        >
          <img src="../../assets/Logo.svg" class=" lg:scale-110" alt="Crop2Cash Logo" />
        </router-link>
      </div>
      <div
        class="hidden md:flex items-center space-x-2 w-1/2"
      >
        <!-- Search Bar -->
        <div class="hidden md:block w-full space-x-4 mx-3">
          <!-- <SearchComponent /> -->
          <div>
            <form class="">
...
<path d="M12.9951 12.2584V12.1667H13.0867H13.5373L16.924 15.5694L16.9248 15.5703C17.0713 15.7167 17.0713 15.9584 16.9248 16.1048C16.7784 16.2512 16.5367 16.2512 16.3903 16.1048L12.9951 12.7096V12.2584ZM12.4738 11.1163L12.2296 11.4012L11.9447 11.6454C10.8846 12.554 9.44102 13.0227 7.90329 12.7653C5.80439 12.4104 4.12299 10.6527 3.86642 8.53976L3.86633 8.53903C3.47268 5.33681 6.16518 2.64431 9.3674 3.03796L9.36813 3.03805C11.4811 3.29462 13.2388 4.97602 13.5937 7.07492C13.8511 8.61265 13.3824 10.0563 12.4738 11.1163ZM4.49507 7.9167C4.49507 10.2678 6.39393 12.1667 8.74507 12.1667C11.0962 12.1667 12.9951 10.2678 12.9951 7.9167C12.9951 5.56556 11.0962 3.6667 8.74507 3.6667C6.39393 3.6667 4.49507 5.56556 4.49507 7.9167Z" fill="#323232" stroke="#96A397"/>
        ...
        <button
          class=" px-3 lg:px-6 hidden lg:flex justify-center items-center py-2 rounded-md ld:rounded-xl bg-secondary hover:scale-105 transition hover:bg-textPrimary focus:bg-secondary/80 active:bg-secondary/70 disabled:bg-textPrimary/40"
        >
      ...
      <!-- Nav Links -->
      <div class="flex flex-row space-x-3 lg:space-x-8">
          <div class="flex justify-center items-center links" @click="$emit('someEvent')">
            <div
              class="flex justify-center items-center w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-secondary/20"
            >
              <img src="../../assets/shopping_bag.svg" class="md:scale-90" alt="Cart" />
            </div>
            <div
          ...
          <div class="flex justify-center items-center links" @click="showOtherNavLinks = !showOtherNavLinks">
            <div
              class="flex justify-center items-center w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-secondary/20"
            >
          ...
          <div v-show="showOtherNavLinks" class="absolute right-5 md:right-10 top-20 z-20 w-64 py-2 px-3 mt-2 bg-gray-100 border rounded-md">
            <div class="flex flex-col space-y-6 bg-white py-2 px-3">
              <div class="flex items-center links">
                ...
                <div>
                  <button @click="handleLogout" class="flex w-full items-center links"
                  >
                  <svg class="w-4 h-4 text-secondary" viewBox="0 0 36 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
